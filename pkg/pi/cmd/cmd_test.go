...
func testData() (*api.PodList, *api.ServiceList) {
	pods := &api.PodList{
		...
		Items: []api.Pod{
			{
				ObjectMeta: metav1.ObjectMeta{Name: "nginx", Namespace: "default", ResourceVersion: "10"},
				Spec:       apitesting.DeepEqualSafePodSpec(),
			},
			{
				ObjectMeta: metav1.ObjectMeta{Name: "alpine", Namespace: "default", ResourceVersion: "11"},
				Spec:       apitesting.DeepEqualSafePodSpec(),
			},
		},
	}
	svc := &api.ServiceList{
		...
		Items: []api.Service{
			{
				ObjectMeta: metav1.ObjectMeta{Name: "http", Namespace: "default", ResourceVersion: "12"},
...
func TestNormalizationFuncGlobalExistence(t *testing.T) {
	...
	root := NewPiCommand(cmdutil.NewFactory(nil), os.Stdin, os.Stdout, os.Stderr)
