...
func (e shortcutExpander) getShortcutMappings() ([]pi.ResourceShortcuts, error) {
	res := []pi.ResourceShortcuts{}
	...
	res = append(res, pi.ResourcesShortcutStatic...)
	return res, nil
}
